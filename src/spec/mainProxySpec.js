...
describe("main", () => {
  ...
  it("should start proxy daemon with standard handlers", function() {
  ...
  it("should start proxy daemon with handlers after enable", function() {
  ...
  it("should start proxy daemon with handlers after disable", function() {
    // Set up for this test
    self.commander.disable = TEST_HANDLERS_TO_DISABLE.join(",")
